...
drop if StartDate == "Start Date" | Progress != "100" | Finished == "False" | Q1 != "SIGUIENTE"
...
/*
clear
import excel "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data\Survey_B1_Dec15_2020.xlsx", sheet("Sheet0") firstrow
gen Block = 1
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\block1.dta", replace

clear
import excel "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data\Survey_B2_Dec15_2020.xlsx", sheet("Sheet0") firstrow
gen Block = 2
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\block2.dta", replace

clear
import excel "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data\Survey_B3_Dec15_2020.xlsx", sheet("Sheet0") firstrow
gen Block = 3
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\block3.dta", replace

clear
use "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\block1.dta"
append using "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\block2.dta"
append using "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\block3.dta"
drop if StartDate == "Start Date" | Progress != "100" | Finished == "False" | Q1 != "SIGUIENTE"

save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data.dta, replace
*/
...
// TTU PC code
//clear
//use "C:\Users\gar14685\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data.dta", clear

clear
use "/Users/memesmacbookair/Library/CloudStorage/OneDrive-TexasTechUniversity/PUBLICATIONS/In Progress/complex_supply_chain/data_output/data.dta", clear

// HOME PC code
*clear
*use "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data.dta", clear
...
* Save it
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\main_dataset.dta", replace
...
use "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\exp_design.dta", clear
...
* 3.3 Save it
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\dataset_design.dta", replace
...
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\dataset_design2.dta", replace

* 3.5 Use the function append to merge horizontally the two databases for design
use "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\dataset_design2.dta", clear
append using "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\dataset_design.dta"
...
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\new_design.dta", replace

* 3.8 Merge the main dataset and the experimental design
use "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\main_dataset.dta", clear
merge m:1 Block Set Alt using "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\new_design.dta"
...
* 3.9 Save it
*save "C:\Users\gar14685\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data_final.dta", replace // Data updated using TTU PC code
save "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data_final.dta", replace // Data updated using Home PC code
...
// TTU PC code
*use "C:\Users\gar14685\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data_final.dta", clear

// HOME PC code
use "D:\OneDrive - Texas Tech University\PUBLICATIONS\In Progress\complex_supply_chain\data_output\data_final.dta", clear
...
*Model 2- considering Texas as the same place of origin as the United States
mixlogitwtp Choice,  price(PRICEATRIB2)  rand(ASC Born_usa_d Born_can Born_nic Raised_usa_d Raised_can Raised_nic Slaughtered_usa_d Slaughtered_can Slaughtered_nic Fsafety Prod) group(CHOICESITUATION)  id(obs) nrep(25) 
